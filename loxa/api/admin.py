...
class CourseAdmin(admin.ModelAdmin):
    ...
    list_display = ("id","level","code","title","paper_no","owner")
...
#     list_display = ("id","module","title","order","published","live_session")
...
class LessonAdmin(admin.ModelAdmin):
    ...
    fields = ("module", "title", "order", "published", "live_session")